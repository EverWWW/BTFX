...
public partial class CameraCaptureDialog : UserControl
{
    ...
    {
        InitializeComponent();
        DataContext = App.Services.GetRequiredService<CameraCaptureDialogViewModel>();
        _viewModel = (CameraCaptureDialogViewModel)DataContext;
    ...
    private void CameraCaptureDialog_OnUnloaded(object sender, System.Windows.RoutedEventArgs e)
    {
    ...
    private void ViewModel_OnPropertyChanged(object? sender, System.ComponentModel.PropertyChangedEventArgs e)
    {
        ...
        if (e.PropertyName == nameof(CameraCaptureDialogViewModel.CaptureState))
        {
        ...
        else if (e.PropertyName == nameof(CameraCaptureDialogViewModel.SideOutputPath)
                 || e.PropertyName == nameof(CameraCaptureDialogViewModel.FrontOutputPath))
        {
            if (_viewModel.IsCompletedState)
            {
                _ = PrepareCompletedPlaybackSourcesAsync();
